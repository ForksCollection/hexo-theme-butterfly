...
!(function (e, t) {
    ...
    function he(e, t, n, r, i) {
        ...
        if (
            ...
            lo.shouldConvert = !1;
            for (
                var a = e._props, s = e.$options._propKeys || [], c = 0; c < s.length; c++
            ) {
                var u = s[c];
        ...
        if (!e(r)) {
            ...
            if (
                ...
                return new ho(
                    ...
                    void 0,
                    void 0,
                    a, { Ctor: r, propsData: l, listeners: f, tag: c, children: s }
                );
            }
        }
    }
    ...
    function Qe(e, t) {
        ...
        if (Array.isArray(e) || "string" == typeof e)
            ...
            for (
                a = Object.keys(e), n = new Array(a.length), r = 0, o = a.length; r < o; r++
            )
                (s = a[r]), (n[r] = t(e[s], s, r));
        return n;
    }
    ...
    function tn(e) {
        ...
        for (i = 0; i < e.length; i++)
            if (((r = n), (n = e.charCodeAt(i)), s)) 39 === n && 92 !== r && (s = !1);
                ...
                if (47 === n) {
                    for (
                        var h = i - 1, m = void 0; h >= 0 && " " === (m = e.charAt(h)); h--
                    );
                    (m && _a.test(m)) || (l = !0);
                }
    ...
    function Dn(e, t) {
        ...
        (n = Ln(e.data)) && h(r, n);
        for (var o = e;
            (o = o.parent);) o.data && (n = Ln(o.data)) && h(r, n);
        return r;
    }
    ...
    function Zr(e, t) {
        ...
        return (
            (Ts = n),
            (Es = i), { render: "with(this){return " + o + "}", staticRenderFns: r }
        );
    }
    ...
    var Bo,
        ...
        Ta = p(function (e) {
            if (
                ...
                return e;
            for (
                var t = e.charAt(0).toUpperCase() + e.slice(1), n = 0; n < Sa.length; n++
            ) {
                var r = Sa[n] + t;
    ...
    var Fa =
        ...
        za = (function (i) {
            ...
            function _(e) {
                ...
                if (t(i))
                    for (
                        t((n = i.hook)) && t((n = n.destroy)) && n(e), n = 0; n < S.destroy.length;
                        ++n
                    )
                        S.destroy[n](e);
                if (t((n = e.children)))
    ...
    return (
        (pt.prototype.$mount = function (e, t) {
            ...
            if (!n.render) {
                ...
                if (r) {
                    var i = cc(
                        r, { shouldDecodeNewlines: es, delimiters: n.delimiters },
                        this
                    ),
                        o = i.render,
                        a = i.staticRenderFns;
                                                ...
                                                botui.message
                                                    ...
                                                    .then(function () {
                                                        botui.message
                                                            .add({
                                                                delay: 1500,
                                                                content: "也做前端, html/js/ts/css/jQuery/spring/node.js/vue 通吃, 技术栈很杂, 看我 GitHub 主页",
                                                            })
                                                            .then(function () {
                                                                botui.message
                                                                    .add({
                                                                        delay: 1800,
                                                                        content: "最喜欢的游戏: RainboxSix: Siege",
                                                                    })
                                                                    .then(function () {
                                                                        botui.action
                                                                            .button({
